...
<template>
    <nav class="bg-blue-900 p-4 flex flex-row justify-between items-center text-white">
        <div id="logo" class="flex items-center hover:text-lime-500 active:text-lime-500">
            <a href="/">
        ...
        <DropdownLink :href="route('logout')" method="post" as="button" class="font-bold">
        Se déconnecter
        </DropdownLink>
    </nav>
</template>